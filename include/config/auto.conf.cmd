deps_config := \
	...
	drivers/gpu/drm/bridge/digi/Kconfig \
	...
	drivers/net/can/spi/mcp25xxfd/Kconfig \
...
ifneq "$(KERNELVERSION)" "5.4.84-dey"
include/config/auto.conf: FORCE
endif
ifneq "$(CC_VERSION_TEXT)" "aarch64-dey-linux-gcc (GCC) 10.2.0"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "aarch64-dey-linux-gcc"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "aarch64-dey-linux-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "."
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "aarch64-dey-linux-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "aarch64-dey-linux-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE

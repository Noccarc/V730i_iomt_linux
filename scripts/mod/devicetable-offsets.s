...
// 0 "" 2
// scripts/mod/devicetable-offsets.c:234: 	DEVID(vop_device_id);
// 234 "scripts/mod/devicetable-offsets.c" 1
	
.ascii "->SIZE_vop_device_id 8 sizeof(struct vop_device_id)"	//
// 0 "" 2
// scripts/mod/devicetable-offsets.c:235: 	DEVID_FIELD(vop_device_id, device);
// 235 "scripts/mod/devicetable-offsets.c" 1
	
.ascii "->OFF_vop_device_id_device 0 offsetof(struct vop_device_id, device)"	//
// 0 "" 2
// scripts/mod/devicetable-offsets.c:236: 	DEVID_FIELD(vop_device_id, vendor);
// 236 "scripts/mod/devicetable-offsets.c" 1
	
.ascii "->OFF_vop_device_id_vendor 4 offsetof(struct vop_device_id, vendor)"	//
// 0 "" 2
// scripts/mod/devicetable-offsets.c:238: 	DEVID(cosm_device_id);
// 238 "scripts/mod/devicetable-offsets.c" 1
	
.ascii "->SIZE_cosm_device_id 32 sizeof(struct cosm_device_id)"	//
// 0 "" 2
// scripts/mod/devicetable-offsets.c:239: 	DEVID_FIELD(cosm_device_id, name);
// 239 "scripts/mod/devicetable-offsets.c" 1
	
.ascii "->OFF_cosm_device_id_name 0 offsetof(struct cosm_device_id, name)"	//
// 0 "" 2
// scripts/mod/devicetable-offsets.c:242: }
#NO_APP
	mov	w0, 0	//,
	ret	
	.cfi_endproc
